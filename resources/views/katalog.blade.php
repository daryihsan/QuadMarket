...
<body class="bg-gray-50">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
            <div class="flex items-center space-x-2">
                ...
                <!-- <span class="text-xl font-bold text-gray-800">QuadMarket</span> -->
            </div>
                ...
                <form method="GET" action="{{ route('katalog') }}" class="space-y-6">
                    ...
                    <div class="pt-4 border-t border-gray-200">
                        ...
                        <div class="flex space-x-2 text-xs">
                            <!-- Input Minimum Harga (nilai default dari controller atau filter) -->
                    ...
                    @foreach ($products as $product)
                        <div class="bg-white rounded-lg shadow hover:shadow-lg transition border border-gray-100 overflow-hidden">
                            ...
                            @if ($product->image_url)
                                <img src="{{ $product->image_url }}" class="w-full h-40 object-cover" alt="{{ $product->name }}">
                            @else
                            ...
                            <div class="p-3">
                                ...
                                <p class="text-xs text-gray-500 mb-2">
                                    {{ $product->store_name }} • {{ $product->location }}
                                </p>

                                {{-- Rating --}}
                                <div class="flex items-center text-xs">
                                    <span class="font-semibold text-yellow-500 mr-1">⭐ {{ $product->rating }}</span>
    ...
    <footer class="bg-white border-t border-gray-100 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center text-gray-600 text-sm">
            <p>&copy; 2025 QuadMarket. Semua hak dilindungi.</p>
        </div>
    </footer>
