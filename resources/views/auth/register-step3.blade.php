...
<input class="hidden" id="dropzone-file-pic" type="file"/>
</label>
</div>
</div>
<div class="flex flex-col gap-2">
...
<input class="hidden" id="dropzone-file-ktp" type="file"/>
</label>
</div>
</div>
</div>
