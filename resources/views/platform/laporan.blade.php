        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white rounded-t-lg shadow">
                <div class="flex border-b">
                    <a href="{{ route('platform.laporan') }}" class="px-6 py-4 text-blue-900 font-semibold border-b-2 border-blue-900">
                        Daftar Penjual
                    </a>
                    <a href="{{ route('platform.laporan.provinsi') }}" class="px-6 py-4 text-gray-600 hover:text-gray-800">
            ...
            <div class="bg-white shadow px-6 py-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        <label class="text-gray-700">Filter berdasarkan status :</label>
