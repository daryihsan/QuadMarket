    ...
    <div class="flex min-h-screen">
        ...
        <main class="main-content">
            <div class="flex justify-between items-center mb-8">
                ...
                {{-- Ganti placeholder gambar dengan tag yang konsisten --}}
            ...
            <div class="bg-white rounded-t-lg shadow">
                <div class="flex border-b">
                    ...
                    <a href="{{ route('platform.laporan.provinsi') }}" class="px-6 py-4 text-blue-900 font-semibold border-b-2 border-blue-900 whitespace-nowrap">
