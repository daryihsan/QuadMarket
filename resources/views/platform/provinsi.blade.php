...
<body class="bg-gray-200">
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-lg">
            ...
            <!-- Menu -->
            <nav class="p-4">
                <a href="{{ route('platform.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg mb-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                    </svg>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('platform.laporan') }}" class="flex items-center space-x-3 px-4 py-3 bg-gray-100 text-gray-800 rounded-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white rounded-t-lg shadow">
                <div class="flex border-b">
                    <a href="{{ route('platform.laporan') }}" class="px-6 py-4 text-gray-600 hover:text-gray-800">
                        Daftar Penjual
                    </a>
                    <a href="{{ route('platform.laporan.provinsi') }}" class="px-6 py-4 text-blue-900 font-semibold border-b-2 border-blue-900">
                        Penjual per Provinsi
                    </a>
                    <a href="{{ route('platform.laporan.produk') }}" class="px-6 py-4 text-gray-600 hover:text-gray-800">
                        Produk Lengkap
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white shadow px-6 py-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        <label class="text-gray-700">Filter berdasarkan Provinsi :</label>
                        <select class="border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="bg-white shadow rounded-b-lg overflow-hidden">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800">Toko Sejahtera</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800">Toko Tembakang</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800">Toko Makmur Jaya</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800">Warung Berkah</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800">Toko Sumber Rezeki</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-800">Kios Mentari</td>
                ...
                <div class="bg-white px-6 py-4 border-t flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <button class="p-2 rounded hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed">
                            <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                            </svg>
                        </button>
                        <button class="px-3 py-1 rounded bg-blue-500 text-white font-medium">1</button>
                        <button class="px-3 py-1 rounded hover:bg-gray-100 text-gray-700">2</button>
                        <span class="text-gray-600">...</span>
                        <button class="px-3 py-1 rounded hover:bg-gray-100 text-gray-700">10</button>
