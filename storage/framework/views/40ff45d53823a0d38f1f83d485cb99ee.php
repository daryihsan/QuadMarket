...
<form action="<?php echo e(route('register.step2.post')); ?>" method="POST" class="space-y-6">
<?php echo csrf_field(); ?>
...
<div>
    ...
    <textarea
        ...
        placeholder="Masukkan alamat lengkap toko Anda"><?php echo e(old('alamat_pic')); ?></textarea>
    <?php $__errorArgs = ['alamat_pic'];
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <select name="kabupaten"
            ...
            <option value="Jakarta Pusat" <?php echo e(old('kabupaten')=='Jakarta Pusat'?'selected':''); ?>>Jakarta Pusat</option>
            <option value="Bandung" <?php echo e(old('kabupaten')=='Bandung'?'selected':''); ?>>Bandung</option>
            <option value="Semarang" <?php echo e(old('kabupaten')=='Semarang'?'selected':''); ?>>Semarang</option>
        </select>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/QuadMarketPPL/resources/views/auth/register/step2.blade.php ENDPATH**/ ?>