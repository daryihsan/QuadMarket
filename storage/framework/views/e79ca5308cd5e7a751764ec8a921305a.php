                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="bg-white border rounded-lg p-6 mb-4 relative">
                            ...
                            <img id="mainProductImage" src="<?php echo e(asset('images/main-phone.png')); ?>" alt="Samsung Galaxy A56" class="w-full rounded" onerror="this.src='https://via.placeholder.com/600x500/f0f0f0/666666?text=Samsung+Galaxy+A56'">
                        </div>

                        <!-- 5 Thumbnails Kecil -->
                        <div class="grid grid-cols-5 gap-2 mb-6">
                            <img src="<?php echo e(asset('images/thumb1.png')); ?>" class="w-full h-24 object-cover rounded border cursor-pointer hover:border-blue-500 hover:shadow-md transition-all" onclick="changeMainImage('<?php echo e(asset('images/thumb1.png')); ?>')" onerror="this.src='https://via.placeholder.com/100x120/90ee90/666666?text=1'">
                            <img src="<?php echo e(asset('images/thumb2.png')); ?>" class="w-full h-24 object-cover rounded border cursor-pointer hover:border-blue-500 hover:shadow-md transition-all" onclick="changeMainImage('<?php echo e(asset('images/thumb2.png')); ?>')" onerror="this.src='https://via.placeholder.com/100x120/d3d3d3/666666?text=2'">
                            <img src="<?php echo e(asset('images/thumb3.png')); ?>" class="w-full h-24 object-cover rounded border cursor-pointer hover:border-blue-500 hover:shadow-md transition-all" onclick="changeMainImage('<?php echo e(asset('images/thumb3.png')); ?>')" onerror="this.src='https://via.placeholder.com/100x120/90ee90/666666?text=3'">
                            <img src="<?php echo e(asset('images/thumb4.png')); ?>" class="w-full h-24 object-cover rounded border cursor-pointer hover:border-blue-500 hover:shadow-md transition-all" onclick="changeMainImage('<?php echo e(asset('images/thumb4.png')); ?>')" onerror="this.src='https://via.placeholder.com/100x120/d3d3d3/666666?text=4'">
                            <img src="<?php echo e(asset('images/thumb5.png')); ?>" class="w-full h-24 object-cover rounded border cursor-pointer hover:border-blue-500 hover:shadow-md transition-all" onclick="changeMainImage('<?php echo e(asset('images/thumb5.png')); ?>')" onerror="this.src='https://via.placeholder.com/100x120/90ee90/666666?text=5'">
                        </div>
                            ...
                            <div class="space-y-6">
                                <div class="border-t pt-4">
                                    <div class="flex items-start space-x-3">
                                        <!-- FOTO REVIEWER 1 -->
                                        <img src="<?php echo e(asset('images/reviewer1.png')); ?>" alt="James" class="w-10 h-10 rounded-full object-cover" onerror="this.src='https://ui-avatars.com/api/?name=James+A&background=4a90e2&color=fff&size=40'">
                                        <div class="flex-1">
                                ...
                                <div class="border-t pt-4">
                                    <div class="flex items-start space-x-3">
                                        <!-- FOTO REVIEWER 2 -->
                                        <img src="<?php echo e(asset('images/reviewer12.png')); ?>" alt="Michelle" class="w-10 h-10 rounded-full object-cover" onerror="this.src='https://ui-avatars.com/api/?name=Michelle&background=e27a90&color=fff&size=40'">
                                        <div class="flex-1">
                    ...
                    <div>
                        ...
                        <div class="border rounded-lg p-5 mb-4 hover:shadow-md transition-all">
                            <div class="flex items-start justify-between">
                                <div class="flex items-start space-x-3">
                                    <!-- LOGO TOKO -->
                                    <img src="<?php echo e(asset('images/store-logo.png')); ?>" alt="Store" class="w-12 h-12 rounded-full object-cover" onerror="this.src='https://ui-avatars.com/api/?name=National+Ponsel&background=00bcd4&color=fff&size=50&bold=true'">
                                    <div>
