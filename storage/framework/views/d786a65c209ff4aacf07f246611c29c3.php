    ...
    <main class="main-content">
        ...
        <div class="bg-white shadow px-6 py-4">
            <div class="flex justify-between items-start flex-wrap gap-4">
                <form method="GET" action="<?php echo e(route('platform.laporan.produk')); ?>"
                    ...
                    <select name="kategori"
                        ...
                        <option value="Semua Kategori" <?php echo e($kategoriFilter === 'Semua Kategori' ? 'selected' : ''); ?>>
                            Semua Kategori
                        </option>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat); ?>" <?php echo e($kategoriFilter === $cat ? 'selected' : ''); ?>>
                                <?php echo e($cat); ?>
                    ...
                    <select name="rating"
                        ...
                        <option <?php echo e($ratingFilter === 'Semua Rating' ? 'selected' : ''); ?>>Semua Rating</option>
                        <option <?php echo e($ratingFilter === '4+' ? 'selected' : ''); ?>>4+ ★</option>
                        <option <?php echo e($ratingFilter === '3+' ? 'selected' : ''); ?>>3+ ★</option>
                    </select>

                    
                    <select name="harga"
                            class="border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-[140px]">
                        <option <?php echo e($hargaFilter === 'Semua Harga' ? 'selected' : ''); ?>>Semua Harga</option>
                        <option value="termurah" <?php echo e($hargaFilter === 'termurah' ? 'selected' : ''); ?>>Termurah</option>
                        <option value="termahal" <?php echo e($hargaFilter === 'termahal' ? 'selected' : ''); ?>>Termahal</option>
                    </select>
                </form>

                
                <a href="<?php echo e(route('platform.laporan.download', ['type' => 'produk'])); ?>"
        ...
        <div class="bg-white shadow rounded-b-lg overflow-hidden">
                ...
                <table class="w-full">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-600">
                                <?php echo e($product->user->nama_toko ?? ($product->user->name ?? '-')); ?>
            ...
            <div class="bg-white px-6 py-4 border-t flex items-center justify-between flex-wrap gap-4">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-semibold"><?php echo e($products->count()); ?></span> produk
                </div>
            </div>
        </div>
    </main>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/QuadMarketPPL/resources/views/platform/pdf/laporan_produk_rating.blade.php ENDPATH**/ ?>