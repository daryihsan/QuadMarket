    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar">
            ...
            <nav class="space-y-2">
                ...
                <a href="<?php echo e(route('platform.dashboard')); ?>" class="nav-link active"><i class="fas fa-chart-line mr-3"></i> Dashboard</a>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/QuadMarketPPL/resources/views/platform/dashboard.blade.php ENDPATH**/ ?>