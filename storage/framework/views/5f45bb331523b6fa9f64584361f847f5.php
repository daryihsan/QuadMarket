<header class="shadow-md sticky top-0 bg-white z-50">
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        ...
        <div class="flex-1 max-w-sm mx-8 hidden md:block">
            <form action="<?php echo e(route('search')); ?>" method="GET" class="relative" id="header-search-form">
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/QuadMarketPPL/resources/views/layouts/header.blade.php ENDPATH**/ ?>