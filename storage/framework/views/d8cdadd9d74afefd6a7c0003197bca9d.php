        ...
        <main class="flex-1 ml-64 p-8">
            ...
            <div class="bg-white rounded-t-lg shadow">
                <div class="flex border-b">
                    <a href="<?php echo e(route('platform.dashboard')); ?>" class="px-6 py-4 text-gray-600 hover:text-gray-800 hover:bg-gray-50 transition-colors whitespace-nowrap">
                        Daftar Penjual
                    </a>
...
</html><?php /**PATH C:\laragon\www\QuadMarket\resources\views/platform/produk.blade.php ENDPATH**/ ?>