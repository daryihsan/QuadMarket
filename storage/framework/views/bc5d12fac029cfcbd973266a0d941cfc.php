        ...
        <main class="main-content">
            ...
            <div class="bg-white rounded-t-lg shadow">
                <div class="flex border-b">
                    <a href="<?php echo e(route('platform.laporan')); ?>" class="px-6 py-4 text-blue-900 font-semibold border-b-2 border-blue-900 whitespace-nowrap hover:bg-gray-50 transition-colors">
                        Daftar Penjual
                    </a>
