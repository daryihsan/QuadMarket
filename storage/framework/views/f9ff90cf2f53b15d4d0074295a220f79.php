    ...
    <div class="flex h-screen">
        ...
        <div class="hidden lg:flex w-1/2 bg-quad-dark-blue p-16 flex-col justify-center items-start text-white">
            ...
            <img src="<?php echo e(asset('assets/quadmarket-logo.png')); ?>" 
                alt="QuadMarket Logo" 
                class="w-29 h-24 mr-0 ml-20">
                <!-- <span class="text-3xl font-semibold">QuadMarket</span> -->
            </div>
            
            <h1 class="text-6xl font-bold mb-4 leading-tight">Selamat Datang Kembali, Penjual</h1>
        ...
        <div class="w-full lg:w-1/2 p-8 sm:p-16 flex flex-col justify-center">
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-6">
                ...
                <div class="pt-2">
                    <button type="submit" 
                            class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-blue-600 hover:bg-blue-600/90 text-white font-semibold py-3 px-8 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-quad-light-blue transition duration-150 ease-in-out">
            ...
            <p class="mt-8 text-center text-gray-500">
                Belum Punya Akun? 
                <a href="<?php echo e(route('register.step1')); ?>" class="font-medium text-quad-light-blue hover:text-blue-700">Daftar</a>
            </p>
...
<?php /**PATH C:\laragon\www\QuadMarket\resources\views/auth/login.blade.php ENDPATH**/ ?>